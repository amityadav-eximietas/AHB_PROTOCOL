...
function void ahb_mas_seq_item::post_randomize();
  ...
  burst_calculation();
  data_in();
  `uvm_info("DEBUG", $sformatf("Randomized Values: enb_e=%0d, burst_e=%0d, size_e=%0d, burst_len=%0d",
                                                  enb_e, burst_e, size_e, burst_len), UVM_MEDIUM)
endfunction: post_randomize

// function for burst clculation
...
// function for storing data in queue
...
// function for calculating number of bytes
