...
class ahb_mas_seq_item #(int ADDR_WIDTH=32, DATA_WIDTH = 32) extends uvm_sequence_item ;
  ...
  //factory registration 	   
    `uvm_object_utils_begin(ahb_mas_seq_item#(ADDR_WIDTH,DATA_WIDTH))
	  ...
	  `uvm_field_int(hclk, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(hresetn, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_queue_int(haddr_q, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_queue_int(hwdata_q, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_queue_int(hrdata_q, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(hstrb, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(hsize, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(htrans, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(hready_out, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(hresp, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(hsel, UVM_ALL_ON | UVM_HEX)
	  `uvm_field_int(hready, UVM_ALL_ON | UVM_HEX)
...
//--------------------------------------------------------------------------
  ...
  constraint ALIGN_ADDR {soft start_addr % 4 == 0; }         
  ...
  constraint ADDR {haddr_q.size() == burst_len;  start_addr inside {[1:1000]}; }	
